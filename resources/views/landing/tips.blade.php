    ...
    <div class="heading">
      <div class="container">
        <div class="row d-flex justify-content-center text-center">
          <div class="col-lg-8">
            <h1>Cara Beramin Kuis Interaktif</h1>
          </div>
        </div>
      </div>
    </div>
    <nav class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li class="current">Cara Bermain Kuis Interaktif</li>
        </ol>
      </div>
    </nav>
  </div>
...
@section('content')
<section id="details" class="details section mb-4">

    <!-- Section Title -->
    <div class="container mb-4 section-title" data-aos="fade-up">
